...
public class BrandPromoDTO {
	String memNick, memName, entCrn, entPhone, memId;
	...
	public String toString() {
		return "BrandPromoDTO [memNick=" + memNick + ", memName=" + memName + ", entCrn=" + entCrn + ", entPhone="
				+ entPhone + ", memId=" + memId + ", entdMainPic=" + entdMainPic + ", entdShort=" + entdShort
				+ ", entdURL=" + entdURL + ", entdIntro=" + entdIntro + ", entdIntroPic=" + entdIntroPic + ", entdPic1="
				+ entdPic1 + ", entdPic2=" + entdPic2 + ", entdPic3=" + entdPic3 + ", entdExplain1=" + entdExplain1
				+ ", entdExplain2=" + entdExplain2 + ", entdExplain3=" + entdExplain3 + ", entdConfirm=" + entdConfirm
				+ "]";
	}
