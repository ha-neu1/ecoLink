...
window.addEventListener("DOMContentLoaded", function() {
	  ...
	  //document.getElementById("crn_view").style.display = "none";
	  ...
	  //radiobox2.addEventListener("click", function() {
	    ...
	    //document.getElementById("crn_view").style.display = "";
	    ...
	    $("#btn_submit").click(function() {
	        $.ajax({
	            ...
	            error: function(request, status, e) {
	                alert("아이디 찾기에 실패했습니다.다음에 다시 시도해주세요.");
                                            ...
                                            <td>
                                                <p class="check">
                                                    ...
                                                    <label id="check_label2" for="check_method2">
                                                        <span id="search_type_mobile_lable">사업자 등록 번호로 찾기</span>
                                                    </label>
                                                    -->
                                                </p>
                                            </td>
